...
RectangularPrism::RectangularPrism(const Point3D &minVertex, const Point3D &maxVertex)
    :
      minVertex_(minVertex),
      maxVertex_(maxVertex)
{
    volume_ = (maxVertex_.x - minVertex_.x) * (maxVertex_.y - minVertex_.y) * (maxVertex_.z - minVertex_.z);
