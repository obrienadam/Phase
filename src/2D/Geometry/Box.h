...
public:
  ...
  Scalar momentOfInertia() const { return momentOfInertia_; }
  ...
  const Vector2D &lower() const { return lower_; }

  const Vector2D &upper() const { return upper_; }
