...
GhostCellImmersedBoundary::FixedBcStencil::FixedBcStencil(
...
void GhostCellImmersedBoundary::FixedBcStencil::initInterpolationCoeffs(
    const ImmersedBoundaryObject &ibObj, const FiniteVolumeGrid2D &grid) {
