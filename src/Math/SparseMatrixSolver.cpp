...
void SparseMatrixSolver::set(
    const std::vector<std::tuple<Index, Index, Scalar>> &entries) {
...
Scalar SparseMatrixSolver::solveLeastSquares() {
  throw Exception("SparseMatrixSolver", "solveLeastSquares",
                  "least squares solver is not available for this sparse "
                  "matrix solver type.");
}
