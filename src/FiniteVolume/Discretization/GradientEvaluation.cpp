...
//- Scalar gradients
    void
    computeGradient(GradientEvaluationMethod method, const CellGroup &group, ScalarFiniteVolumeField &phi,
    ...
    Gradient::Gradient(const ScalarFiniteVolumeField& phi)
            :
    ...
    void Gradient::compute(const CellGroup& group)
    {
        computeFaces();
        VectorFiniteVolumeField &gradPhi = *this;
    ...
    void Gradient::computeWeighted(const ScalarFiniteVolumeField &w, const CellGroup &group)
    {
        computeFaces();
        VectorFiniteVolumeField &gradPhi = *this;
